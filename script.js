...
const Cards = [[1,
   {
    id:1,  
    source: "http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/engranaje_Mesa-de-trabajo-1.jpg"
  }],[2,

  {
    id:2,             source:"http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/memorama-04.jpg",
  }],[3,
  
  {
    id:3,   
 source:"http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/memorama-02.jpg",
  }],[4,
  
  {
    id:4,      source:"http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/memorama-03.jpg",
  }],[5,
  
  {
    id:5,      source:"http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/memorama-06.jpg",
  }], [6,
  
  {
    id:6,      source:"http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/memorama-05.jpg",
  }  ]
]
...
class Card {
  ...
  renderCard(id) {
    const src = "http://museopalaciodebellasartes.gob.mx/wp-content/uploads/2020/04/mpbamemo-07.jpg"
...
class Game{  
  constructor(onEndGame, elCanvas) {
    ...
    this.numTuplesOK = 0
    this.numClicks = 0
    this.resultArray = ["¡Excelente!", "Nada mal", "Tienes que mejorar"]
